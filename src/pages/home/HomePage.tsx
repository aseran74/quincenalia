        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-2xl p-0 md:p-0 flex flex-col md:flex-row overflow-hidden border">
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white border-t md:border-t-0 md:border-l border-gray-100">
              <h3 className="text-2xl font-bold mb-6 text-primary">Contacto directo</h3>
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center gap-3 text-lg text-gray-700"><Phone className="w-6 h-6 text-primary"/> <a href="tel:+34000000000" className="hover:underline">+34 000 000 000</a></li>
                <li className="flex items-center gap-3 text-lg text-gray-700"><MapPin className="w-6 h-6 text-primary"/> Dirección Ficticia, 123, Ciudad, CP, País</li>
              </ul>
              <div className="flex items-center gap-2 mt-2 md:mt-0 md:mb-0 md:ml-0" style={{ alignItems: 'center' }}>
                <svg className="w-6 h-6" fill="#25D366" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981zm11.387-5.464c-.074-.124-.272-.198-.57-.347-.297-.149-1.758-.868-2.031-.967-.272-.099-.47-.149-.669.149-.198.297-.768.967-.941 1.165-.173.198-.347.223-.644.074-.297-.149-1.255-.462-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.521.151-.172.2-.296.3-.495.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372s-1.04 1.016-1.04 2.479 1.065 2.876 1.213 3.074c.149.198 2.095 3.2 5.076 4.487.709.306 1.263.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.695.248-1.29.173-1.414z"/></svg>
                <a href="https://wa.me/34000000000" target="_blank" rel="noopener noreferrer" className="hover:underline text-lg text-gray-700">WhatsApp</a>
              </div>
              <p className="text-primary font-semibold text-lg mt-6">🌟 Propietario + Viajero + Inversor: Todo en uno. 🌟</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                 ...
                 <li className="flex items-center gap-2">
                    ...
                    <a href="tel:+34000000000" className="hover:text-white transition-colors">+34 000 000 000</a></li>
                 <li className="flex items-start gap-2">
                    <MapPin className="w-4 h-4 text-primary mt-1"/>
                    <span>Dirección Ficticia, 123<br/>Ciudad, CP, País</span>
                 </li>
              </ul>
